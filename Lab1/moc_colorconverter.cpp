...
void ColorConverter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->showWarning((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->showInfo((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ColorConverter::*)(const QString & )>(_a, &ColorConverter::showWarning, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ColorConverter::*)(const QString & )>(_a, &ColorConverter::showInfo, 1))
            return;
    }
}
...
// SIGNAL 0
void ColorConverter::showWarning(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ColorConverter::showInfo(const QString & _t1)
{
